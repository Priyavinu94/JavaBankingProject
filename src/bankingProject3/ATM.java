...
public class ATM extends BankingRules implements StandardProcess {
	...
	public ATM(PersonAccount account) {
		super(account);
		this.account = account;
		balance = account.getAccountBalance(); // setting the value of balance variable
	}
	...
	public boolean isUserValid(String cardNumber, String pinNo) {
		if (cardNumber.equals(account.getCardNumber()) && pinNo.equals(account.getPinNo())) {
			return true;
		}
		return false;
	}
